...
if (location.hostname == 'localhost') {
  device_info = 'device_id=860806022733629&imsi=460025010714767&device_name=M040&os_type=android&os_version=4.1.1&country_code=CN&language=zh&app_id=072cb4d9d9d5dfd23ed2981e5e33fe59&app_package_name=com.dlnetwork.example&cid=dianjoy&app_version=3.0.5&appvc=305&library_version=1.0.0.s&screen_density=320&screen_layout_size=2&screen_width=800&screen_height=1280&net=WIFI'
  device_info = {
    device_id: '860806022733629',
    imsi: '460025010714767',
    device_name: 'M040',
    os_type: 'android',
    os_version: '4.1.1',
    country_code: 'CN',
    language: 'zh',
    app_id: '072cb4d9d9d5dfd23ed2981e5e33fe59',
    app_package_name: 'com.dlnetwork.example',
    cid: 'dianjoy',
    app_version: '3.0.5',
    appvc: '305',
